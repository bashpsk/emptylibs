 ...
 * @property normalImage A low-quality bitmap representation of the page, used for previews.
 * @property scaledImage A high-quality bitmap representation of the page for zoomed state.
...
internal data class PdfPageData(
    ...
    val width: Int = 0,
    val height: Int = 0,
    val normalImage: ImageBitmap? = null,
    val scaledImage: PdfBitmapData? = null,
